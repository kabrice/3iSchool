...
//selected value onload
        ...
        $scope.loadHomePage = function (userid, anneeid, groupeid, niveauid) {
            ...
            console.log($scope.lectureContenu);
        ...
        $scope.clickToOpen = function () {
            ngDialog.open({ template: '/administration', className: 'ngdialog-theme-default' });
        };
    ...
    .controller("lectureContenuCtrl", function ($scope, contenuService, ngDialog, $rootScope) {
